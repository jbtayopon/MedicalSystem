        ...
        <div class="container mt-5">
            <div class="card shadow">
                <div class="card-header py-3">
                    ...
                    <h3 class="m-0 font-weight-bold text-primary"><i class="fas fa-fw fa-tooth"></i>Dental Record</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="dental_record.php" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" name="id_number" class="form-control" value="<?php echo isset($_GET['id_number']) ? htmlspecialchars($_GET['id_number']) : ''; ?>" required>
                        </div>
...
<div class="tooth-chart">
    ...
    <div class="tooth-section">
        <h4 class="section-title">UPPER LEFT</h4><div></div><div></div>
    ...
    <div class="tooth-section">
       <h4 class="section-title">UPPER RIGHT</h4><div></div><div></div>
        <div></div><div></div> <div></div><div></div><div></div><div></div>
    ...
    <div class="tooth-section">
        <h4 class="section-title">LOWER LEFT</h4><div></div><div></div>
        <div></div><div></div><div></div><div></div><div></div><div></div>
    ...
    <div class="tooth-section">
        <h4 class="section-title">LOWER RIGHT</h4><div></div><div></div>
        <div></div><div></div><div></div><div></div><div></div><div></div>
...
<div class="tooth-chart-label1">
        ...
        <div></div><h5 class="">HEALTHY</h5><div></div><h5 class="">CAVITY</h4><div></div>
        <h5 class="">FILLING</h5><div></div><h5 class="">EXTRACTED</h5><div></div><div></div>
        <i class="fas fa-circle circle-icon-1"></i><div></div>
        <i class="fas fa-circle circle-icon-2"></i><div></div>
        <i class="fas fa-circle circle-icon-3"></i><div></div>
        <i class="fas fa-circle circle-icon-4"></i><div></div>
    </div>
</div></div>
